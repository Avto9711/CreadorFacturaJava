...
public class DialogAcercaDe extends JDialog{
	...
	public void GUI(){
		...
		titulo = new JLabel("VMETA SISTEMA C y C", new ImageIcon("imagenes/VMETAICONacercade"), JLabel.CENTER);
